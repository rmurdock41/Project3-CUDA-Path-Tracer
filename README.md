...
## Detailed implementation and benchmark report

The original CIS 565 renderer report is preserved below, including its complete implementation notes, benchmark tables, analysis, comparison renders, and charts.

**University of Pennsylvania, CIS 565: GPU Programming and Architecture, Project 3**

- **Muqiao Lei** — [LinkedIn](https://www.linkedin.com/in/muqiao-lei-633304242/) · [GitHub](https://github.com/rmurdock41)
- **Tested on:** Windows 10, Intel Core i7-11800H, NVIDIA GeForce RTX 3060 Laptop GPU

The original course project implemented glTF model loading, refractive materials, depth of field, BVH acceleration, Russian Roulette path termination, and GPU performance experiments.

![Original CUDA path tracer cover render](img/top.png)
...
| --------------- | ------ | -------- |
| No RR           | 92 fps | -        |
| RR (minDepth=1) | 92 fps | 0%     |
| RR (minDepth=3) | 91 fps | -1%     |
...
| --------------- | ------ | -------- |
| No RR           | 32 fps | -        |
| RR (minDepth=1) | 37 fps | +16%     |
| RR (minDepth=3) | 36 fps | +13%     |
